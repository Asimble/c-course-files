...
public:
    ...
    // The line Revenue revenue; declares an object of the Revenue class within the RepairShop class.
    // This means that each instance of the RepairShop class will have its own object.
    Revenue revenue;
    ...
    void addCarForRepair(const Car &car)
    {
        ...
        // Update revenue based on the car's price divided by 3000
